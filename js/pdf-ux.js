$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/zh-cn/cloud_volumes/pdfs/sidebar/";
    let baseUrlPages = "/zh-cn/cloud_volumes/pdfs/pages/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"cloud_volumes.zh-cn.zip";
